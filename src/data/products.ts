...
export const products: Product[] = [
  ...
  {
    slug: "ivory-chikan-kurta-set",
    name: "Ivory Chikan Kurta Set",
    price: 1699,
    mrp: 3199,
    category: "Kurta Sets",
    group: "Indian Wear",
    images: [indian, detail, coord],
    colors: [
      { name: "Ivory", hex: "#f3e9d9" },
      { name: "Blush", hex: "#e8c8bf" },
    ],
    sizes,
    fabric: "Cotton-silk blend with hand-finished thread embroidery.",
    description:
      "Delicate tonal chikankari across the yoke and panels, paired with a straight kurta, pants and a featherweight dupatta.",
    rating: 4.9,
    reviews: 331,
    tags: ["bestseller", "new"],
  },
